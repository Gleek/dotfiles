...
module.bindFns = function()
   ...
   local bindings = {
      ...
      {"alt", "1", function() y.moveToWorkspace("web") end},
      {"alt", "2", function() y.moveToWorkspace("emacs") end},
      {"alt", "3", function() y.moveToWorkspace("term") end},
      {"alt", "4", function() y.moveToWorkspace("comm") end},
      {"alt", "5", function() y.moveToWorkspace("zoom") end},
      {"alt", "6", function() y.moveToWorkspace("e1") end},
      {"alt", "7", function() y.moveToWorkspace("e2") end},
      {"alt", "8", function() y.moveToWorkspace("e3") end},
      {"alt", "9", function() y.moveToWorkspace("e4") end},
      {"alt", "0", function() y.moveToWorkspace("e5") end},

      {"shift-alt", "1", function() y.moveWindowToWorkspace("web") end},
      {"shift-alt", "2", function() y.moveWindowToWorkspace("emacs") end},
      {"shift-alt", "3", function() y.moveWindowToWorkspace("term") end},
      {"shift-alt", "4", function() y.moveWindowToWorkspace("comm") end},
      {"shift-alt", "5", function() y.moveWindowToWorkspace("zoom") end},
      {"shift-alt", "6", function() y.moveWindowToWorkspace("e1") end},
      {"shift-alt", "7", function() y.moveWindowToWorkspace("e2") end},
      {"shift-alt", "8", function() y.moveWindowToWorkspace("e3") end},
      {"shift-alt", "9", function() y.moveWindowToWorkspace("e4") end},
